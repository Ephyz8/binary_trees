...
/**
 * new_node - Func that creates a new_node in a linked_list
 * @node: Type pointer of node to be created
 * Return: the node created
 */
level_t *new_node(binary_tree_t *node)
{
	level_t *new;
 ...
 */
void _push(binary_tree_t *node, level_t *head, level_t **tail)
{
	level_t *new;
